...
@interface WAMsgNodePkgPreloadLogic : NSObject <IWAMsgNodeResourceMgrExt>
{
...
- (BOOL)isAppInfoValid:(id)arg1;
- (long long)getReqTimeInterval;
- (BOOL)canRestorePreloadWidget;
- (BOOL)needReqPreloadWidgetInfo;
- (BOOL)isMatchCommonContidtion;
- (void)reloadData;
- (void)dealloc;
