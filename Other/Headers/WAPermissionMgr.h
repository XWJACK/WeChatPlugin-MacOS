...
@interface WAPermissionMgr : MMService <MMCGIDelegate, MMService>
{
...
+ (BOOL)checkJsAPI:(id)arg1 haveRunMode:(unsigned int)arg2;
...
- (id)generateLaunchCGIUserInfo:(id)arg1 debugMode:(unsigned int)arg2 enterScene:(unsigned int)arg3 sessionId:(id)arg4 isFromBackground:(BOOL)arg5;
- (id)tryGetLocalResponseWithAppid:(id)arg1 inScene:(unsigned int)arg2;
- (BOOL)requestLaunchPermissonInfoWithAppID:(id)arg1 userName:(id)arg2 debugModeType:(unsigned int)arg3 appVersion:(unsigned int)arg4 scene:(unsigned int)arg5 appServiceType:(unsigned int)arg6 sessionId:(id)arg7 pagePath:(id)arg8 isFromBackground:(BOOL)arg9 requestType:(unsigned int)arg10 dicLaunchParameter:(id)arg11;
