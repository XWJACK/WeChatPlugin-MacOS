...
#import "TXIAudioSystemSpeakerTestDelegate-Protocol.h"
...
#import "TXIScreenCaptureAndEncDelegate-Protocol.h"

@class NSDateFormatter, NSString, NSView, TRTCConfig, TRTCDashBoard, TRTCParams, TRTCRoomInfo, TRTCVideoEncParam, TXCCaptureAndEnc, TXCScreenAndEnc;
@protocol OS_dispatch_queue, OS_dispatch_source, TRTCAudioFrameDelegate, TRTCCloudDelegate, TRTCVideoRenderDelegate;

@interface TRTCCloud : NSObject <TXINotifyDelegate, TXICaptureAndEncDelegate, TXIRenderAndDecDelegate, TXIAudioSystemEventDelegate, TXBeautyManagerTraitControl, TXIAudioSystemSpeakerTestDelegate, TXIScreenCaptureAndEncDelegate, TXICustomRenderDelegate, TXICustomPreprocessDelegate, TRTCAudioFrameDelegate, TXIAudioCorePlayDelegate, TXIAudioEffectDelegate>
{
    ...
    BOOL _remoteAudioMute;
    BOOL _remoteVideoMute;
    BOOL _enableAudioEarMonitoring;
...
- (void)appendLocalAudio:(id)arg1 timeStamp:(unsigned long long)arg2 channels:(int)arg3 isMic:(BOOL)arg4;
...
- (void)onScreenCaptureEncAudio:(id)arg1;
...
- (void)setWatermark:(struct NSImage *)arg1 streamType:(long long)arg2 rect:(struct CGRect)arg3;
- (void)setFilterConcentration:(float)arg1;
- (void)setFilter:(struct NSImage *)arg1;
...
- (BOOL)enableLocalVideoInternal:(BOOL)arg1;
...
- (void)stopPreviewOnView:(id)arg1;
- (void)_startPreviewWithDevice:(id)arg1 view:(id)arg2 withDashboard:(BOOL)arg3;
- (void)stopCameraDeviceTest;
- (void)startCameraDeviceTestInView:(id)arg1;
- (void)startLocalPreview:(struct NSView *)arg1;
- (void)_stopCaptureTest:(int)arg1;
- (void)_startCaptureTest:(int)arg1;
- (void)setDefaultStreamRecvMode:(BOOL)arg1 video:(BOOL)arg2;
- (void)disconnectOtherRoom;
- (void)connectOtherRoom:(id)arg1;
- (void)exitRoomInternalWithStopCapture:(BOOL)arg1 reqExit:(BOOL)arg2;
- (void)exitRoom;
