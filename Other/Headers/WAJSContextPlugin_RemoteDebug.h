...
@class MMTimer, NSMutableArray, NSString, NSWindow, WARemoteDebugMaskView, WARemoteDebugPanelView;
...
@interface WAJSContextPlugin_RemoteDebug : WAJSContextPluginBase
{
    ...
    NSWindow *_currentWindow;
}

@property(retain, nonatomic) NSWindow *currentWindow; // @synthesize currentWindow=_currentWindow;
...
- (void)onAlwaysOnTopButtonChange:(id)arg1;
- (void)initMaskView;
- (void)initPanelView;
