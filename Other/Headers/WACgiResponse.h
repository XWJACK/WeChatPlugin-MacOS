...
@class PBGeneratedMessage, WACgiRequest;

@interface WACgiResponse : NSObject
{
    unsigned int _uiMessage;
    WACgiRequest *_cgiRequest;
    PBGeneratedMessage *_pbResponse;
}

@property(retain, nonatomic) PBGeneratedMessage *pbResponse; // @synthesize pbResponse=_pbResponse;
