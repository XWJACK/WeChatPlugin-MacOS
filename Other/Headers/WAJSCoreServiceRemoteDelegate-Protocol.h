...
@class NSDictionary, NSString, WAAppTask, WARemoteJSCoreIDWrap;

@protocol WAJSCoreServiceRemoteDelegate <NSObject>
@property(nonatomic) __weak WAAppTask *task;
...
- (void)beginDebugWithRoomID:(NSString *)arg1 pkgInfo:(NSString *)arg2 debugUrl:(NSString *)arg3 channelType:(unsigned int)arg4 proxyPort:(unsigned int)arg5 supportCompressAlgo:(unsigned int)arg6;
@end
