...
@interface MMAppReferMessageCellView : MMMessageCellView <MMCTTextViewDelegate, IMessageExt, EmoticonDownloadMgrExt, IMMMessageImageExt, IMMMessageVideoServiceExt>
{
...
@property(retain, nonatomic) CAShapeLayer *bgColorLayer; // @synthesize bgColorLayer=_bgColorLayer;
