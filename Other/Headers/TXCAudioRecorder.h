...
@interface TXCAudioRecorder : NSObject <TXIAudioCoreRecordDelegate>
{
    ...
    NSString *_Id;
    BOOL _isMicStartedSuccessfully;
...
@property(nonatomic) BOOL isCustomRecord; // @synthesize isCustomRecord=_isCustomRecord;
@property(nonatomic) BOOL isMute; // @synthesize isMute=_isMute;
@property(readonly) BOOL isPause; // @synthesize isPause=_isPause;
