...
@class CAOpenGLLayer, NSColor, NSCondition, NSMutableArray, NSMutableDictionary, NSMutableSet;
@protocol WACanvasViewDelegate;

@interface WACanvasView : NSView
{
...
@property(retain, nonatomic) NSColor *bgNSColor; // @dynamic bgNSColor;
- (void)setupBuffers;
- (void)setupContext;
- (void)setupLayer;
