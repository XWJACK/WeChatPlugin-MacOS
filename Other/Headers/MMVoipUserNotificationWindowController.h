...
@class AVAudioPlayer, MMAvatarImageView, MMTimer, MessageData, NSMutableArray, NSMutableDictionary, NSString, NSTextField, NSView, SVGButton, WCContactData, WXCMultiTalkGroup;
...
@property(retain, nonatomic) WXCMultiTalkGroup *groupInfo; // @synthesize groupInfo=_groupInfo;
