...
@class MMCTTextView, MMContactProfileData, MMContactProfileMgr, MMProfileFooterView, MMProfileHeaderView, MMTableView, MessageData, NSScrollView, NSString, NSVisualEffectView, NSWindow, RBLPopover, RBLPopoverBackgroundView, WCContactData;
