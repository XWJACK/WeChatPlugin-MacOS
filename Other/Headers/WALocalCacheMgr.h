...
@class MMCache, NSMutableDictionary, NSString, WAPackageDownloadLogic, WAPackageInfoCacheLogic;
...
- (void)notifyOnCompleteExtension:(BOOL)arg1 errorCode:(unsigned int)arg2 errorMsg:(id)arg3 pkgUrl:(id)arg4 moduleName:(id)arg5;
- (void)onDownloadTaskRecordTime:(double)arg1 appId:(id)arg2;
- (void)onDownloadTaskCompletion:(long long)arg1 taskUrl:(id)arg2 fileData:(id)arg3;
