...
@class AppProductItem, DownloadVideoReportData, FavoritesItem, MMTranslateResult, MessageDataPackedInfo, NSArray, NSData, NSMutableArray, NSString, OpenSDKAppBrandItem, SecondMsgNode, SendImageInfo, UploadVideoReportData, WAAppMsgItem, WCPayInfoItem;
