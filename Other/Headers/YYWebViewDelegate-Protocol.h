...
- (NSString *)getTouchemulatorScriptStr;
...
- (BOOL)allowsAvoidSystemMenuItem;
- (BOOL)allowsAutoMediaPlay;
- (BOOL)allowsInlineMediaPlay;
- (void)webViewDidReceiveResponse:(NSURLResponse *)arg1;
...
- (BOOL)webView:(id <YYWebViewInterface>)arg1 shouldStartLoadWithRequest:(NSURLRequest *)arg2 navigationType:(long long)arg3 isMainFrame:(BOOL)arg4;
@end
