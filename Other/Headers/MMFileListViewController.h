...
@class JWCTableView, MMFileKeyIndexModel, MMFileListCellOPHandler, MMFileListDataSource, MMFileMultiSelectView, MMIgnoreEventView, MessageData, NSArray, NSImageView, NSPopUpButton, NSString, NSTextField, NSView, RFOverlayScrollView;
...
@interface MMFileListViewController : NSViewController <JWCTableViewDataSource, MMFileItemOPHandlerDelegate, JWCTableViewDelegate, NSTableViewDelegate>
{
    ...
    MMFileMultiSelectView *_multiSelectView;
...
@property(retain, nonatomic) MMFileMultiSelectView *multiSelectView; // @synthesize multiSelectView=_multiSelectView;
