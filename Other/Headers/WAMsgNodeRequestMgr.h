...
@interface WAMsgNodeRequestMgr : MMService <MMService>
{
...
- (void)sendRequest:(id)arg1 data:(id)arg2 scene:(unsigned int)arg3 shouldUseCache:(BOOL)arg4 coreId:(unsigned int)arg5 debugMode:(unsigned long long)arg6 userInfo:(id)arg7;
