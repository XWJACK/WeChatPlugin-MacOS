...
@class AVCaptureConnection, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureSession, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, NSObject, NSString;
...
@interface TXCCameraCapturer : TXCModule <AVCaptureVideoDataOutputSampleBufferDelegate, TXCCapturer>
{
    ...
    AVCaptureDevice *_selectedCamera;
...
@property(retain, nonatomic) AVCaptureDevice *selectedCamera; // @synthesize selectedCamera=_selectedCamera;
