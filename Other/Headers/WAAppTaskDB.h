...
- (BOOL)setLocalStorageData:(id)arg1 dataType:(id)arg2 withKey:(id)arg3 lastModifyTime:(unsigned int)arg4;
...
- (BOOL)setLocalStorageMainStorageLength:(unsigned long long)arg1 lastModifyTime:(unsigned int)arg2;
