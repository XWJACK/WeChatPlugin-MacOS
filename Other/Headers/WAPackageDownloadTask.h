...
@class NSDate, NSMutableData, NSString, NSURLSessionDataTask;
...
@property(retain, nonatomic) NSMutableData *wxpkgData; // @synthesize wxpkgData=_wxpkgData;
