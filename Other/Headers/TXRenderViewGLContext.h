...
- (void).cxx_destruct;
- (void)destroy;
- (void)renderWithViewportSize:(struct CGSize)arg1 format:(int)arg2 vertices:(float [8])arg3 textureCoords:(float [8])arg4;
- (void)setupRGBATexture:(unsigned int)arg1;
- (void)setupTextureWithY:(const char *)arg1 U:(const char *)arg2 V:(const char *)arg3 format:(int)arg4 bufferSizes:(const int *)arg5 imageSize:(struct CGSize)arg6;
- (void)_compileShader;
- (void)_setupTexture;
- (void)setup;
