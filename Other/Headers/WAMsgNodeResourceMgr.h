...
- (void)reportCostTimeWithReportItem:(id)arg1 eventId:(unsigned long long)arg2 result:(BOOL)arg3 beginTime:(unsigned long long)arg4 endTime:(unsigned long long)arg5 dataSize:(unsigned int)arg6 isSync:(BOOL)arg7;
