...
- (void).cxx_destruct;
- (BOOL)testUnpackPublicResPkgFromPath:(id)arg1 isDebugMode:(unsigned long long)arg2;
- (BOOL)unpackPublicResPkgFromPath:(id)arg1 isDebugMode:(unsigned long long)arg2;
...
- (BOOL)hasUnpackedPackageWithAppId:(id)arg1 version:(unsigned long long)arg2 isDebugMode:(unsigned long long)arg3;
- (BOOL)unpackPkgFromPath:(id)arg1 appid:(id)arg2 version:(unsigned long long)arg3 isDebugMode:(unsigned long long)arg4 packageType:(unsigned long long)arg5;
