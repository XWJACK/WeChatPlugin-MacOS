...
@interface MMAppMouseEventView : MMView
{
    CDUnknownBlockType _mouseDownBlock;
    CDUnknownBlockType _mouseUpBlock;
    CDUnknownBlockType _mouseScrollBlock;
}

@property(copy, nonatomic) CDUnknownBlockType mouseScrollBlock; // @synthesize mouseScrollBlock=_mouseScrollBlock;
