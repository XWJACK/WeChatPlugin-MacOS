...
@interface WAPackageDownloadLogic : NSObject <NSURLSessionDelegate, NSURLSessionDataDelegate, ICdnComMgrExt>
{
...
- (void).cxx_destruct;
- (void)wapkgDownloadFinishedWith:(unsigned char)arg1 clientMsgID:(id)arg2 fileData:(id)arg3;
