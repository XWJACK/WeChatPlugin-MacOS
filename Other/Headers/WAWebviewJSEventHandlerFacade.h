...
@interface WAWebviewJSEventHandlerFacade : NSObject
{
    id <WAWebviewJSEventHandlerBaseDelegate> _m_delegate;
...
@property(nonatomic) __weak id <WAWebviewJSEventHandlerBaseDelegate> m_delegate; // @synthesize m_delegate=_m_delegate;
- (void).cxx_destruct;
