...
#import "WAWebviewJSEventHandlerBaseDelegate-Protocol.h"

@class NSMutableArray, NSMutableDictionary, NSString, NSView, WAWebviewJSEventHandlerFacade;
@protocol WebViewJSLogicDelegate, YYWebViewInterface;

@interface WebViewJSLogicImpl : MMObject <JSEventHandler, WAWebviewJSEventHandlerBaseDelegate>
{
    NSMutableDictionary *_jsCallbackHooks;
    NSMutableDictionary *_jsUrlHooks;
    NSMutableArray *_jsEvents;
    WAWebviewJSEventHandlerFacade *_jsEventHandlerFacade;
