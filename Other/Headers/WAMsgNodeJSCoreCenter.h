...
- (void)onJSCore:(unsigned int)arg1 executed:(id)arg2 reserve:(BOOL)arg3;
- (void)reportCostTimeWithEventID:(unsigned long long)arg1 coreDataList:(id)arg2 isFinished:(BOOL)arg3 dataSize:(unsigned int)arg4;
- (void)reportCostTimeWithEventID:(unsigned long long)arg1 coreData:(id)arg2 isFinished:(BOOL)arg3 dataSize:(unsigned int)arg4;
...
- (BOOL)shouldShowJSLogEntranceWithDebugMode:(unsigned long long)arg1;
- (id)fontGroup;
