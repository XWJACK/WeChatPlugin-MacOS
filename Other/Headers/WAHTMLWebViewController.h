...
@class MMWebProgressBar, NSString, WAWebViewController, WAWebViewPlugin_HTMLWeb;

@interface WAHTMLWebViewController : WXBaseWebViewController <WAPageFlowReportExtention>
{
