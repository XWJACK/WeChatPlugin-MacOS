...
- (void)drawCanvas:(unsigned int)arg1 actions:(id)arg2 reset:(BOOL)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)setInteractionEnable:(BOOL)arg1 mode:(int)arg2 canvasId:(unsigned int)arg3;
