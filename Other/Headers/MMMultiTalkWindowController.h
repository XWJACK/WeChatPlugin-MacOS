...
@class MMTimer, NSArray, NSDictionary, NSMutableDictionary, NSString, NSTextField, NSView, WCContactData, WXCGroupMember, WXCMultiTalkGroup;
...
- (void)layoutTipsLabelWithContent:(id)arg1;
...
- (void)timerFunction;
- (void)updateTipsLabel:(id)arg1 widthDuration:(int)arg2;
