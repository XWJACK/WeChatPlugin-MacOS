...
@class NSArray, NSDictionary, NSString, NSViewController, WAAppTaskExtInfo, WAPermissionResult, WAWebViewController;
...
- (void)webviewWillResize:(WAWebViewController *)arg1;
...
- (void)enterBackgroundFrom:(WAWebViewController *)arg1 mode:(long long)arg2 animate:(BOOL)arg3 completion:(void (^)(void))arg4;
...
- (void)webView:(WAWebViewController *)arg1 didPresent:(NSViewController *)arg2;
