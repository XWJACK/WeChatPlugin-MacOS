...
@class CContact, NSArray, NSDictionary, NSString, NSViewController, WAPackageConfig, WAWebViewController;

@protocol WAAppTaskLoaderContextDelegate <NSObject>
- (void)onDidPresentWithPresentingViewController:(NSViewController *)arg1;
