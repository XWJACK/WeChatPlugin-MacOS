...
@interface MMMultiTalkMgr : MMService <IMessageExt, AccountServiceExt, WXCMultiTalkApiDelegate, WXCAssistHelperDelegate, MultiTalkCgiDelegate, AVVideoDeviceSetupSessionDelegate, AVVideoDataSource, AVVideoDeviceDelegate, AVVideoDeviceSessionDelegate, MonoServiceMsgDelegate, MMVoipUserNotificationDelegate, IContactMgrExt, IGroupMgrExt, MMVoipBaseWindowControllerDelegate, MMMultiTalkWindowDelegate, MonoServiceMsgLogicDelegate, MMNetExt, MMService>
{
