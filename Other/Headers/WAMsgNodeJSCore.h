...
@class JSContext, NSArray, NSCondition, NSDateFormatter, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, NSThread, WAMsgNodeJSCoreData;
@protocol IWAMsgNodeJSCoreDelegate;

@interface WAMsgNodeJSCore : NSObject <IWAMsgNodeRequestMgrExt>
{
    BOOL _hasInjected;
...
@property(retain, nonatomic) id confirmWindow; // @synthesize confirmWindow=_confirmWindow;
...
- (BOOL)reportPublicJSInsideIDKeyInfo:(unsigned int)arg1 withKey:(unsigned int)arg2 andValue:(unsigned int)arg3;
- (BOOL)reportPublicJSInsideKVInfo:(unsigned int)arg1 andValue:(id)arg2;
