...
+ (id)decryptData:(id)arg1 withKeyRef:(struct OpaqueSecKeyRef *)arg2 strip:(BOOL)arg3;
+ (id)encryptData:(id)arg1 privateKey:(id)arg2;
+ (id)encryptString:(id)arg1 privateKey:(id)arg2;
+ (id)encryptData:(id)arg1 withKeyRef:(struct OpaqueSecKeyRef *)arg2;
+ (struct OpaqueSecKeyRef *)addPrivateKey:(id)arg1;
+ (struct OpaqueSecKeyRef *)addPublicKey:(id)arg1;
