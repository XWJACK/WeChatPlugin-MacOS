...
@class NSArray, NSString, WAAppTask, WAAppWindowController, WANavigationController;
...
@interface WAAppOpenParameter : MMObject
{
    ...
    WANavigationController *_m_navigationController;
    WAAppWindowController *_m_taskPresentingWindowController;
    WAAppTask *_m_appTask;
...
@property(retain, nonatomic) WAAppTask *m_appTask; // @synthesize m_appTask=_m_appTask;
@property(nonatomic) __weak WAAppWindowController *m_taskPresentingWindowController; // @synthesize m_taskPresentingWindowController=_m_taskPresentingWindowController;
@property(nonatomic) __weak WANavigationController *m_navigationController; // @synthesize m_navigationController=_m_navigationController;
